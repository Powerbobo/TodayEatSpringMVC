	                        		...
	                        		<tr align="center">
	                        			<td colspan="5">
	                        				<c:forEach begin="${ pInfo.startNavi }" end="${ pInfo.endNavi }" var="p">
	                        					<!-- var : 변수명, value : url -->
	                        					<c:url var="pageUrl" value="/inquiry/search.do">
	                        						<!-- 쿼리 스트링 -->
	                        						<c:param name="page" value="${ p }"></c:param>
	                        						<!-- 페이징 처리 이후 검색 시 search 페이지로 이동 -->
	                        		...
	                        		<tr>
	                        			...
	                        			<form action="/inquiry/search.do" method="get">
	                        				<select name="searchCondition">
	                        					...
	                        					<option value="content" <c:if test="${ searchCondition == 'condition' }">selected</c:if>>내용</option>
	                        				</select>
	                        				<input type="text" name="searchKeyword" placeholder="검색어를 이용하세요" value="${searchKeyword }">
